...
class OnboardingFirstView: UIView {
    ...
    private func setupViews() {
        ...
        logoImageView.image = R.image.onboarding_logo_1()
        
        titleLabel.text = R.string.localization.onfirstTitle()
        titleLabel.font = .systemFont(ofSize: 22)
        titleLabel.numberOfLines = 0
        titleLabel.textAlignment = .center
        
        subtitleLabel.text = R.string.localization.onfirstSubtitle()
        subtitleLabel.font = .systemFont(ofSize: 12)
        subtitleLabel.numberOfLines = 0
        subtitleLabel.textAlignment = .center
        
        nextButton.setTitle(R.string.localization.onfirstButtonNext(), for: .normal)
    }
